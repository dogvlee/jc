 ...
 * Raw JSON lives in research/niim-templates/; converter is pure.
 */
const { importNiimTemplate } = require('../core/niim-template-import');
const productJson = require('../../research/niim-templates/product.json');
const medicineJson = require('../../research/niim-templates/medicine-price.json');
const stateGridJson = require('../../research/niim-templates/state-grid.json');
const c1Json = require('../../research/niim-templates/c1-default.json');
